...
require("lib/sendgrid-php.php");

$email = new \SendGrid\Mail\Mail(); 
$email->setFrom("test@example.com", "Example User");
$email->setSubject("Sending with SendGrid is Fun");
$email->addTo("landonz@gmail.com", "Example User");
$email->addContent("text/plain", "and easy to do anywhere, even with PHP");
$email->addContent(
    "text/html", "<strong>and easy to do anywhere, even with PHP</strong>"
);
$sendgrid = new \SendGrid('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');
try {
...
$apiKey = getenv('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');
